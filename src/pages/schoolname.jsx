...
const SchoolName = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#f8f9fc] p-5 relative overflow-hidden">
      ...
      <div className="bg-white/80 backdrop-blur-xl border border-white/50 shadow-[0_8px_30px_rgb(0,0,0,0.04)] rounded-[32px] w-full max-w-md p-10 relative z-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
