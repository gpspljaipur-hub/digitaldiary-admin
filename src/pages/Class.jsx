...
const Class = () => {
  ...
  return (
    <div className="w-full h-full p-2 relative">
      ...
      <div className="bg-white shadow-[0_4px_20px_-4px_rgba(0,0,0,0.03)] rounded-[20px] overflow-hidden border border-gray-50 w-full md:w-1/2 min-w-[350px]">
        ...
        <div className="fixed inset-0 bg-gray-900/40 backdrop-blur-sm flex justify-center items-center z-50 p-4">
          <div className="bg-white w-full max-w-lg rounded-[24px] shadow-2xl relative animate-in fade-in zoom-in-95 duration-200">
            <div className="flex items-center justify-between p-6 border-b border-gray-100">
              <h2 className="text-xl font-bold text-[#0B132B]">Add New Class</h2>
              <button
                type="button"
            ...
            <form onSubmit={handleClassSubmit} className="p-6">
              <div className="mb-5">
